    ...
    extends CPIButtonInventoryAbstract
{
    ...
    public CPIButtonR4(){
        super(new Operand[]{
                ...
                new Operand(Op.Close,new float[]{}),
                new Operand(Op.MoveTo,new float[]{18.0f,4.0f}),
                new Operand(Op.LineTo,new float[]{20.0f,12.0f}),
                new Operand(Op.LineTo,new float[]{18.0f,20.0f}),
                new Operand(Op.LineTo,new float[]{20.0f,20.0f}),
                new Operand(Op.LineTo,new float[]{22.0f,12.0f}),
                new Operand(Op.LineTo,new float[]{20.0f,4.0f}),
                new Operand(Op.Close,new float[]{}),
                new Operand(Op.MoveTo,new float[]{26.0f,4.0f}),
                new Operand(Op.LineTo,new float[]{28.0f,12.0f}),
                new Operand(Op.LineTo,new float[]{26.0f,20.0f}),
                new Operand(Op.LineTo,new float[]{28.0f,20.0f}),
                new Operand(Op.LineTo,new float[]{30.0f,12.0f}),
                new Operand(Op.LineTo,new float[]{28.0f,4.0f}),
                new Operand(Op.Close,new float[]{}),
            }, new Operand[]{
