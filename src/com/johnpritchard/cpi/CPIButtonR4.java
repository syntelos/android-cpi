    ...
    extends CPIButtonInventoryAbstract
{
    ...
    public CPIButtonR4(){
        super(new Operand[]{
                ...
                new Operand(Op.Close,new float[]{}),
                new Operand(Op.MoveTo,new float[]{26.0f,2.0f}),
                new Operand(Op.LineTo,new float[]{28.0f,6.0f}),
                new Operand(Op.LineTo,new float[]{26.0f,10.0f}),
                new Operand(Op.LineTo,new float[]{28.0f,10.0f}),
                new Operand(Op.LineTo,new float[]{30.0f,6.0f}),
                new Operand(Op.LineTo,new float[]{28.0f,2.0f}),
                new Operand(Op.Close,new float[]{}),
            }, new Operand[]{
